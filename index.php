...
<html lang="zxx">
<head>
	<title>Yoga Classes Management System | Home Page</title>
			...
			<div class="hs-item">
				<div class="hs-style-2">
					<div class="container-fluid h-100">
						<div class="row h-100">
							<div class="col-lg-6 h-110 d-none d-lg-flex align-items-xl-end align-items-lg-center">
								<div class="hs-img">
									<img src="img/hero-slider/3-2.png" alt="">
								</div>
							</div>
							<div class="col-lg-6 d-flex align-items-center">
								<div class="hs-text-warp">
									<div class="hs-text">
										...
										<p>These classes are the perfect way to learn yoga in the comfort of your own home
 or just about anywhere and experience the incredible healing benefits it has to offer </p>
				...
				<div class="col-lg-6">
					<div class="about-item">
						...
						<div class="ai-text">
							...
							<p>Whether you’re a newbie or a seasoned pro, these powerful yoga poses are
 sure to have you feeling great in no time by helping rejuvenate the mind, body, and spirit.</p>
						</div>
					</div>
					<div class="about-item">
						<div class="ai-icon">
						...
						<div class="ai-text">
							...
							<p>Clear out any stuck energy that is no longer serving you by incorporating
 these yoga poses for spring and inspiring mantras into your yoga practice.</p>
						</div>
					</div>
					<div class="about-item">
						<div class="ai-icon">
						...
						<div class="ai-text">
							<h4>Against Aging</h4>
							<p>Yoga is an excellent anti-aging tool, capable of 
relieving symptoms and in some cases improving medical outcomes.</p>
						</div>
					</div>
...
<?php
$sql="SELECT * from tblclasses order by rand() limit 5";
